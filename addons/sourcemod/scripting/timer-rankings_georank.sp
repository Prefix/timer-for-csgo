...
public SQL_Connect_Database(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	...
	if(g_bSql)
	{
		...
		SQL_TQuery(g_hDatabase, CallBack_Creation, "CREATE TABLE IF NOT EXISTS `ranks_geo` (`id` int(11) NOT NULL AUTO_INCREMENT, `country` varchar(65) NOT NULL, `points` int(11) NOT NULL default 0, PRIMARY KEY (`id`), UNIQUE KEY (country)) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
