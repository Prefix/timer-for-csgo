...
{
	name        = "[TIMER] Hide",
	author      = "Zipcore, exvel, DR. API Improvements",
...
{
	LoadTranslations("drapi/drapi_timer-hide.phrases");
...
public Action:Command_Hide(client, args)
{
	...
	{
		g_bHide[client] = false;
		CPrintToChat(client, "%t", "Hide Disabled");
	}
	else
	{
		g_bHide[client] = true;
		CPrintToChat(client, "%t", "Hide Enabled");
	}
