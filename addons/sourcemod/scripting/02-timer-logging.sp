...
public Timer_Log_(Handle:plugin, num_params) 
{
    ...
    {
		decl String:message[PLATFORM_MAX_PATH], written;
...
{
	decl String:log_line[PLATFORM_MAX_PATH];
...
PrepareLogLine(Handle:plugin, Timer_LogLevel:log_level, const String:message[], String:log_line[PLATFORM_MAX_PATH]) 
{
