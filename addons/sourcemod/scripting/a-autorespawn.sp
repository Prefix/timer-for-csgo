...
public OnPluginStart()
{
	...
	sm_auto_respawn_time = CreateConVar("sm_auto_respawn_time", "1.0", "How many seconds to delay the respawn");
...
public Event_PlayerDeath(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (respawnState > 0)
	{
		...
		if ((isWorldKiller && respawnState == 1) || (isEnemyKiller && respawnState == 2) || respawnState == 3)
		{
			...
			{
				CreateTimer(respawnTime, RespawnPlayer2, client, TIMER_FLAG_NO_MAPCHANGE);
			}
		}
	}
}
